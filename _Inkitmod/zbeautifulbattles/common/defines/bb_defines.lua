...
NDefines.NCombat.COMBAT_DETECT_RANGE_MULT = 0.90 -- 1.05 Range to engage in combat with other ships is <fleets max attack range> * COMBAT_DETECT_RANGE_MULT
NDefines.NCombat.FLEET_MOVE_MAX_DIST_SHIPS = 100.0	-- 10.0 Max distance that ships are allowed to travel before last ship

NDefines.NGraphics.PLANET_SCALE_SYSTEM = { 0.425, 0.425, 0.325, 0.325, 0.35, 0.5, 0.5, 0.5, 0.75, 0.75 } -- (0.425, 0.325, 0.35, 0.5, 0.5, 0.5, 0.75 ) Scale for each System zoom steps
...
NDefines.NGraphics.MUZZLE_FLASH_DURATION = 2.0 -- 2.0

NDefines.NShip.FLEET_BASE_FORMATION_SCALE = 4 -- 2.0 
